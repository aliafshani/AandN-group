...
const Profile = ({ img, about, medias }) => {
  return (
    <div>
      <div className=" flex flex-col-reverse sm:flex-row justify-evenly pt-28 line-clamp-5 dark:text-violet-50 text-violet-950 text-right font-sans">
        <div className="">
          ...
          <p className="text-lg mt-8 text-center sm:text-left">
            Bachelor's student in Computer engineering and senior front-end
            developer.
          </p>
          <p className="text-lg mt-8 text-center sm:text-left">
            Loves nature and running🌱.
          </p>
          <p className="text-lg mt-8 text-center sm:text-left">
            My expertise is in creating web applications and creating creative
            websites.
          </p>
